...
handleTransaction=async()=>{
  ...
  if(!transactionType){
    ...
    if (isStudentEligible){
      this.initiateBookReturn();
      Alert.alert("Book Returned To The Libarary")
  }
}
    ...
    checkStudentEligibilityForBookIssue=async()=>{
      const studentRef = await db.collection("stundents").where("studentId","==","this.state.scannedStudentId").get()
      ...
      if(studentRef.doc.length==0){
        ...
        Alert.alert("Student Id Doesn't Exist In Database")
      }
      else{
